...
class MCCollectionController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func ConfigureCollection() {
        ...
        // let cellHeight = view.bounds.height - layout.collectionViewContentSize.height
        ...
        mcCollection.contentInsetAdjustmentBehavior = .never
...
//        cell.topAnchor.constraintLessThanOrEqualToSystemSpacingBelow(mcCollection.topAnchor, multiplier: 0)
//        cell.bottomAnchor.constraintLessThanOrEqualToSystemSpacingBelow(mcCollection.bottomAnchor, multiplier: 0)
//        cell.rightAnchor.constraint(equalTo: mcCollection.rightAnchor, constant: 0)
//        cell.leftAnchor.constraint(equalTo: mcCollection.leftAnchor, constant: 0)
